# v0.3 real-runtime scenario fixture: persist-linearized-before-cancel

This branch is one fixed release-only fixture slot for Issue #221 under prerequisite #310.

Fixed Feature: `F-OPERATOR-V03-FI-PERSIST-BEFORE-CANCEL-0001`  
Fixed ref: `verification/v0.3-fi-persist-before-cancel-221`
...
The slot is permanently bound to scenario `persist-linearized-before-cancel` for v0.3. It must not be
