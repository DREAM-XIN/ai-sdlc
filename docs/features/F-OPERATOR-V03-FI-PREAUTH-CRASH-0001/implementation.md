# v0.3 real-runtime scenario fixture: reservation-committed-pre-authorization-crash-recovery

This branch is one fixed release-only fixture slot for Issue #221 under prerequisite #310.

Fixed Feature: `F-OPERATOR-V03-FI-PREAUTH-CRASH-0001`  
Fixed ref: `verification/v0.3-fi-preauth-crash-221`
...
The slot is permanently bound to scenario `reservation-committed-pre-authorization-crash-recovery` for v0.3. It must not be
