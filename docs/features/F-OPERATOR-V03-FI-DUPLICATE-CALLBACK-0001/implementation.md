# v0.3 real-runtime scenario fixture: duplicate-callback

This branch is one fixed release-only fixture slot for Issue #221 under prerequisite #310.

Fixed Feature: `F-OPERATOR-V03-FI-DUPLICATE-CALLBACK-0001`  
Fixed ref: `verification/v0.3-fi-duplicate-callback-221`
...
The slot is permanently bound to scenario `duplicate-callback` for v0.3. It must not be
