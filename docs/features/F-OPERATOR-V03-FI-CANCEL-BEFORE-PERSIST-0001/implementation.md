# v0.3 real-runtime scenario fixture: cancel-before-persist-linearization

This branch is one fixed release-only fixture slot for Issue #221 under prerequisite #310.

Fixed Feature: `F-OPERATOR-V03-FI-CANCEL-BEFORE-PERSIST-0001`  
Fixed ref: `verification/v0.3-fi-cancel-before-persist-221`
...
The slot is permanently bound to scenario `cancel-before-persist-linearization` for v0.3. It must not be
