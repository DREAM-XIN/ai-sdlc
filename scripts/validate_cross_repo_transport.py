...
def main():
    ...
    require("gh workflow run ai-sdlc-bootstrap.yml" in command, "command bridge does not delegate bootstrap to installed caller")
    require("gh workflow run ai-sdlc-plan.yml" in command, "command bridge does not delegate plan to installed caller")
