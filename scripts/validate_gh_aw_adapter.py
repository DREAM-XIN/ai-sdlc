...
def main():
    ...
    require(dispatch["workflow"] == "ai-sdlc-gh-aw-product-copilot.lock.yml", "authoring worker workflow lost")
    require(dispatch["expected_result"]["contract"] == "ai-sdlc-gh-aw-authoring-result-v0.1", "authoring result contract lost")
    require(dispatch["inputs"]["feature_issue_number"] == 3, "trusted authoring Feature Issue input lost")
