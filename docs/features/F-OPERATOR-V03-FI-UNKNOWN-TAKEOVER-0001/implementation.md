# v0.3 real-runtime scenario fixture: unknown-takeover

This branch is one fixed release-only fixture slot for Issue #221 under prerequisite #310.

Fixed Feature: `F-OPERATOR-V03-FI-UNKNOWN-TAKEOVER-0001`  
Fixed ref: `verification/v0.3-fi-unknown-takeover-221`
...
The slot is permanently bound to scenario `unknown-takeover` for v0.3. It must not be
