...
The release effect-safety matrix has its own authoritative validator/workflow.
Keep this file transport-scoped so transport logs cannot drift into stale claims
about how many release scenarios currently have deterministic/orchestration support.
"""
...
def main():
    ...
    print("- rejected dispatch / API error / duplicate receipt => UNKNOWN")
    print("- missing exact run => NOT_LAUNCHED")
    print("- release effect-safety matrix status is validated separately; no scenario-count claim is emitted here")
