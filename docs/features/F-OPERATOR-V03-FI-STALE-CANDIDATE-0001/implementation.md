# v0.3 real-runtime scenario fixture: stale-candidate-result

This branch is one fixed release-only fixture slot for Issue #221 under prerequisite #310.

Fixed Feature: `F-OPERATOR-V03-FI-STALE-CANDIDATE-0001`  
Fixed ref: `verification/v0.3-fi-stale-candidate-221`
...
The slot is permanently bound to scenario `stale-candidate-result` for v0.3. It must not be
